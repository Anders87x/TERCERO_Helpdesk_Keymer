<?php
    class Usuario extends Conectar{
        ...
        /* TODO:Insert */
        public function insert_usuario($usu_nom,$usu_ape,$usu_correo,$usu_pass,$rol_id,$usu_telf,$area_id){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="INSERT INTO tm_usuario (usu_id, usu_nom, usu_ape, usu_correo, usu_pass, rol_id, usu_telf, area_id, fech_crea, fech_modi, fech_elim, est) 
        ...
        /* TODO:Update */
        public function update_usuario($usu_id,$usu_nom,$usu_ape,$usu_correo,$usu_pass,$rol_id,$usu_telf,$area_id){
            $conectar= parent::conexion();
            parent::set_names();
        ...
        public function delete_usuario($usu_id){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="SELECT * FROM tm_usuario where usu_id=xusu_id";
            $sql=$conectar->prepare($sql);
        ...
        public function get_usuario(){
            ...
            tm_area on tm_usuario.area_id = tm_area.area_id
